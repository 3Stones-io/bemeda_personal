defmodule BemedaPersonal.Accounts.UserNotifierTest do
  ...
  setup do
    ...
    job_application = job_application_fixture(user, job_posting, %{state: "Interview Scheduled"})
  ...
  # TODO: Update test when state machine code is merged
