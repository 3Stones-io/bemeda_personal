defmodule BemedaPersonalWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use BemedaPersonalWeb.ConnCase, async: true`, although
  ...
  """
  @spec log_in_user(conn(), Accounts.User.t(), keyword()) :: conn()
