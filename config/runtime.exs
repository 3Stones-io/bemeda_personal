...
#
#     PHX_SERVER=true bin/bemeda_personal start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :bemeda_personal, BemedaPersonalWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :bemeda_personal, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  revision_file = Path.join([:code.priv_dir(:bemeda_personal), "REVISION"])
