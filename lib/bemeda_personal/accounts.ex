defmodule BemedaPersonal.Accounts do
  ...
  """
  @spec deliver_login_instructions(user(), function()) ::
          {:ok, %{to: String.t(), body: String.t()}}
  ...
  def update_user_profile(user, attrs) do
    Repo.update(User.profile_changeset(user, attrs))
  end
  ...
  @doc """
  Returns an `%Ecto.Changeset{}` for changing the user work profile.
  """
  @spec change_user_work_profile(user(), attrs()) :: changeset()
  def change_user_work_profile(work_profile, attrs \\ %{}) do
  ...
  """
  @spec change_user_address(user(), attrs()) :: changeset()
  def change_user_address(address, attrs \\ %{}) do
