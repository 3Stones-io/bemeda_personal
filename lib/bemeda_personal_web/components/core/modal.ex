defmodule BemedaPersonalWeb.Components.Core.Modal do
  @moduledoc """
  ...
  def modal(assigns) do
    ...
    >
      <div
        id={"#{@id}-bg"}
        class="bg-secondary-50/90 fixed inset-0 transition-opacity"
        aria-hidden="true"
      />
      <div
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-secondary-700/10 ring-secondary-700/10 relative hidden rounded-2xl bg-white p-xl shadow-lg ring-1 transition"
            >
