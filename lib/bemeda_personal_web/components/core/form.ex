  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div>
      ...
      <textarea
        ...
        name={@name}
        class={[
          "border mt-2 block w-full rounded-lg text-secondary-900 focus:ring-0 sm:text-sm sm:leading-6 min-h-[6rem]",
          @input_class,
          @errors == [] && "border-secondary-300 focus:border-primary-400",
          @errors != [] && "border-danger-400 focus:border-danger-400"
        ]}
  ...
  def input(assigns) do
    ...
    <div>
      ...
      <input
        ...
        class={[
          "mt-2 block w-full rounded-lg text-secondary-900 focus:ring-0 sm:text-sm sm:leading-6 border p-3",
          @input_class,
          @errors == [] && "border-secondary-300 focus:border-primary-400",
          @errors != [] && "border-danger-400 focus:border-danger-400"
        ]}
