  ...
  def input(%{type: "select"} = assigns) do
    ...
    <div>
      ...
      <select
        ...
        name={@name}
        class={[
          "mt-2 block w-full rounded-md border bg-white shadow-sm focus:ring-0 sm:text-sm p-4",
  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div>
      ...
      <textarea
        ...
        name={@name}
        class={[
          "border p-3 mt-2 block w-full rounded-lg text-secondary-900 focus:ring-0 sm:text-sm sm:leading-6 min-h-[6rem]",
          @input_class,
          @errors == [] && "border-secondary-300 focus:border-primary-400",
          @errors != [] && "border-danger-400 focus:border-danger-400"
        ]}
  ...
  def input(assigns) do
    ...
    <div>
      ...
      <input
        ...
        class={[
          "border p-2 mt-2 block w-full rounded-lg text-secondary-900 focus:ring-0 sm:text-sm sm:leading-6",
          @input_class,
          @errors == [] && "border-secondary-300 focus:border-primary-400",
          @errors != [] && "border-danger-400 focus:border-danger-400"
        ]}
