          ...
          >
            ...
            <:actions>
              <div class="flex gap-3">
                <.button type="button" variant="secondary" phx-click={JS.push("cancel_edit_account")}>
        ...
        <div :if={@live_action in [:view, :edit_account]} class="space-y-6">
          ...
          <div class="pt-12">
            <div class="space-y-6">
              ...
              <div>
                <.text class="font-medium text-gray-700 mb-2">{dgettext("companies", "About")}</.text>
                <.text class="text-gray-500">
              ...
              <div>
                ...
                <.text class="text-gray-500">{@company.location || dgettext("general", "Nil")}</.text>
              </div>
