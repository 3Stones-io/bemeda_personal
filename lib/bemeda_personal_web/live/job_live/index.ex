                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <div class="mt-1">
                        <p class="text-sm text-gray-900 truncate">
                          <.link navigate={~p"/company/#{job.company.id}"} class="text-gray-900 hover:text-indigo-600">
                            <%= job.company.name %>
                          </.link>
                        </p>
                      </div>
                      <div class="mt-1 flex flex-col sm:flex-row sm:flex-wrap sm:mt-0 sm:space-x-6">
                        ...
                        <%= if job.salary_min && job.salary_max do %>
                          <div class="mt-2 flex items-center text-sm text-gray-500 sm:mt-0">
                            <svg class="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                            ...
                            <%= Number.Delimit.number_to_delimited(job.salary_min) %> - <%= Number.Delimit.number_to_delimited(job.salary_max) %> <%= job.currency || "USD" %>
                          </div>
                        <% end %>
                      </div>
                    </div>
