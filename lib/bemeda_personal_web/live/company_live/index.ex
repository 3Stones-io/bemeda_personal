defmodule BemedaPersonalWeb.CompanyLive.Index do
  ...
  def mount(_params, _session, socket) do
    ...
    socket =
      socket
      |> assign(:page_title, "Company Dashboard")
              ...
              <div>
                ...
                <dd class="mt-1 text-sm text-gray-900">
                  <%= if @company.website_url do %>
                    <a href={@company.website_url} target="_blank" class="text-indigo-600 hover:text-indigo-900">
                      <%= @company.website_url %>
                    </a>
                  <% else %>
                    Not specified
                  ...
                  <li class="px-4 py-4 sm:px-6 hover:bg-gray-50">
                    <div class="flex items-center justify-between">
                      <div class="flex-1 min-w-0">
                        <h3 class="text-lg font-medium text-indigo-600 truncate"><%= job.title %></h3>
